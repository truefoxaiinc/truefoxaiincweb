...
export type BlogPost = Common & { status: PublishStatus; title: string; slug: string; category: string; excerpt: string; content: string; author: string; publishedAt: string; readTime: string };
