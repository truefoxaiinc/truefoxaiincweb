...
export default function PageRenderer({ page, managed }: { page: PageData; managed?: { jobs: Job[]; posts: BlogPost[] } }) {
  ...
  return (
    <main id="main-content">
        ...
        <div className="shell inner-hero-content">
          ...
          <Reveal className="inner-console" delay={0.12}>
            {page.slug === "request-quote" ? (
              ...
              <>
                <div><span>PAGE SIGNAL</span></div>
                <p>Meet the people and disciplines behind Truefox AI’s research, product development and client delivery.</p>
                <ul><li>CANADA · HEADQUARTERS</li><li>INDIA · ENGINEERING</li><li>INTERNATIONAL · DELIVERY</li></ul>
              </>
            ) : (
              <>
      ...
      {page.slug !== "request-quote" && page.slug !== "why-choose-us" && page.slug !== "careers" && page.slug !== "products" && page.slug !== "services" && page.slug !== "book-demo" && page.slug !== "clients-partners" && page.slug !== "case-studies" && page.slug !== "faq" && page.slug !== "support" && page.slug !== "contact" && page.slug !== "privacy-policy" && page.slug !== "terms-and-conditions" && page.slug !== "team" && page.slug !== "blog" && (
